...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/25 08:32:08 by ksuebtha          #+#    #+#             */
/*   Updated: 2025/02/25 09:20:52 by ksuebtha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static bool	built_ll(t_input_node **head, char *s, char c, int *input_num)
{
	int				len;
	t_input_node	*node;
	bool			error;
